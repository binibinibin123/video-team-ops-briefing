...
PROJECT_OVERRIDES = {
    '스냅스': {
        ...
        'bullets': ['표지영 현재 스냅스 수정중.', '수정본 전달 후 목요일 중 컨펌 완료 목표.', '컨펌 완료 시 7/7(화)~7/12(일) 총 60건 발행 예정.', '컨펌 완료 시점에 따라 발행 시작일 지연 가능.', '헤븐리젤리 원본 8개는 완료됐지만 후속 수정 가능성은 남음.']
    },
    ...
    '헤븐리젤리': {
        'tone': 'waiting',
        'status': '긴급 · 원본 8개 완료 · 수정대기',
        'stage': '검수/수정대기',
        'priority': '긴급',
        'due': '수정 요청 미정',
        'bullets': ['표지영이 7/1 야근으로 원본영상 8개 모두 완료.', '현재는 수정 요청 가능성 대기.', '수정 요청이 오면 후속 수정량 확인 필요.', '표지영은 지금 스냅스 수정중.', '스냅스 컨펌/차주 60건 조건과 병행 주의.']
    },
    '한손한끼': {
        'tone': 'waiting',
        'status': '종료 · 운영 제외',
...
PEOPLE_OVERRIDES = {
    ...
    '표지영': '헤븐리젤리 원본영상 8개는 7/1 야근으로 완료. 현재 스냅스 수정중이며, 수정본 전달/목요일 컨펌이 차주 60건 발행 시작을 좌우함. 헤븐리젤리는 후속 수정 요청 가능성 대기. 쿠쿠홈시스는 소스 재전달 이슈 보류.',
...
def build():
    ...
    key_changes = [
        ...
        {'label': '헤븐리젤리', 'title': '원본 8개 완료 · 수정대기', 'body': '표지영이 7/1 야근으로 헤븐리젤리 원본 8개를 모두 완료. 다만 수정 요청 가능성은 남아 있어 후속 수정량 확인 필요.'},
        {'label': '스냅스', 'title': '표지영 현재 수정중', 'body': '표지영은 현재 스냅스 수정중. 수정본 전달과 목요일 중 컨펌 여부가 차주 60건 발행 시작을 좌우함.'},
    ...
    recent_updates = [
        {'heading': '2026-07-02 09:41 — 비더후드/최유정/헤븐리젤리/스냅스 최신', 'text': '비더후드는 정희헌+한은지 작업중이며 오늘 20개 추가 시 이번주 마무리. 최유정은 김경은 단독으로 잔여 18개 진행. 헤븐리젤리는 원본 8개 완료/수정대기, 표지영은 현재 스냅스 수정중.'},
        ...
        {'heading': '2026-07-01 14:22 — 헤븐리젤리 신규/스냅스 수정', 'text': '당시 헤븐리젤리 원본 8개와 스냅스 수정이 7/2 마감으로 잡혔고 표지영 과부하를 주의했음. 7/2 최신 기준 헤븐리젤리 원본은 완료, 스냅스는 수정중.'},
    ...
    data = {
        'meta': {
            'title': '영상팀 운영상황판',
            'lastUpdated': '2026-07-02 09:41 KST · 비더후드 20/최유정 18 진행 · 헤븐리젤리 완료 · 스냅스 수정중',
