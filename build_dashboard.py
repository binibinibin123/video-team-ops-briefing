...
PROJECT_OVERRIDES = {
    ...
    '벤슨': {'tone': 'focus', 'bullets': ['여기성 메인 중심.', '이재은 지원은 마무리 완료.', '이재은은 듀오타이트 제작으로 전환 완료.', '신규 소구는 수요일부터 반영 예정.']},
...
PEOPLE_OVERRIDES = {
    ...
    '여기성': '벤슨 메인. 6/30 유20 피크는 여기성 메인 중심 소화 필요. 이재은은 듀오타이트 제작으로 전환 완료. 신규 소구 반영까지 체크.',
    '표지영': '쿠쿠홈시스 원본 1개는 고객사 소스 재전달 이슈로 일정 보류/연기. 새 소스/새 마감 확인 전까지 제작 보류, 7/3~7/4 유10 영향 재확인 필요. 스냅스 후속 우선순위는 재확인 필요.',
...
def build():
    ...
    data = {
        'meta': {
            'title': '영상팀 운영상황판',
            'lastUpdated': '2026-06-30 17:34 KST · 쿠쿠홈시스 원본 1개 소스 재전달 이슈로 일정 보류/캘린더 반영',
