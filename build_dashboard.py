...
PROJECT_OVERRIDES = {
    '스냅스': {
        ...
        'priority': '높음',
        'due': '미정',
        'bullets': ['표지영 원본 6개 제작 완료.', '다음 단계는 고객사 컨펌대기.', '컨펌 전 후속/바리에이션/업로드 전환 불가.', '고객사 컨펌 회신 일정 확인 필요.', '신유빈 지원/관리 기록 유지.']
    },
    ...
    '헤븐리젤리': {'tone': 'waiting', 'bullets': ['표지영 상하목장 1차 소스 수집 및 스냅스 컨펌 추적 이후 재확인.', '후속 우선순위 확인 필요.']},
    '한손한끼': {
        'tone': 'waiting',
        'status': '종료 · 운영 제외',
        'stage': '종료',
...
PEOPLE_OVERRIDES = {
    ...
    '표지영': '스냅스 원본 6개 제작 완료 후 고객사 컨펌대기. 상하목장 소스 수집/폴더링 1차 7/1 오전 40개, 2차 7/3 오전 추가 40개. 쿠쿠홈시스는 고객사 소스 재전달 이슈로 보류, 헤븐리젤리 대기.',
...
def build():
    ...
    key_changes = [
        ...
        {'label': '스냅스', 'title': '원본 6개 제작 완료 · 컨펌대기', 'body': '표지영이 스냅스 원본 6개 제작 완료. 다음 단계는 고객사 컨펌대기이며 컨펌 전 후속/바리에이션/업로드 전환 불가.'},
    ...
    recent_updates = [
        ...
        {'heading': '2026-06-30 23:39 — 스냅스 완료/상하목장 누락 정정', 'text': '스냅스 원본 6개 제작 완료 후 고객사 컨펌대기로 전환. 딜로이트(상하목장) 표지영 소스 수집/폴더링 건도 장부와 앱에 반영.'},
    ...
    data = {
        'meta': {
            'title': '영상팀 운영상황판',
            'lastUpdated': '2026-07-01 00:00 KST · 벤슨 썸넬 테스트 추가 / 스냅스 컨펌대기 / 상하목장 소스수집 반영',
