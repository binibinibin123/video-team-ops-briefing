...
PROJECT_OVERRIDES = {
    ...
    '비더후드': {'tone': 'risk', 'status': '업로드/비축 · 진행중', 'stage': '업로드/비축', 'bullets': ['정희헌 메인.', '7/2 업로드분까지 비축 완료.', '6/30 한은지 지원 투입 이력.', '7/3 유20 + 7/4 유15 잔여분 비축/예약 확인 필요.', '정희헌은 동아제약 새 기획 2개 진행중이라 병행 병목 주의.']},
    ...
    '동아제약': {'tone': 'risk', 'status': '높음 · 제작 진행중 · 정희헌', 'stage': '제작 진행중', 'priority': '높음', 'due': '2026-07-01', 'bullets': ['새 기획 2개 수급 완료.', '정희헌 동아제약 진행중.', '7/1까지 총 3건 제작 예정.', '비더후드 7/3 이후 잔여분과 병행이라 병목 주의.']},
...
PEOPLE_OVERRIDES = {
    ...
    '정희헌': '비더후드 7/2 업로드분까지 비축 완료. 현재 동아제약 새 기획 2개 수급 후 진행중이며 7/1 총 3건 일정 촉박. 7/3 이후 비더후드 잔여분 확인 필요.',
...
def build():
    ...
    key_changes = [
        ...
        {'label': '동아제약', 'title': '새 기획 2개 도착 · 정희헌 진행중', 'body': '동아제약 새 기획 2개가 들어와 정희헌이 진행중. 7/1 총 3건 일정 촉박.'},
    ...
    recent_updates = [
        {'heading': '2026-06-30 15:09 — 비더후드 비축/동아제약 진행', 'text': '비더후드는 7/2 업로드분까지 비축 완료. 동아제약 새 기획 2개가 도착해 정희헌은 동아제약 진행중으로 전환.'},
    ...
    data = {
        'meta': {
            'title': '영상팀 운영상황판',
            'lastUpdated': '2026-06-30 15:09 KST · 비더후드 7/2 비축 완료/동아제약 새 기획 2개 진행/캘린더 반영',
